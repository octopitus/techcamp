        ...
        <div className="promo-list">
          <div className="list-item">
            ...
            <p className="item-body">
              More than 50 topics presented in each events. TechCamp Saigon Uni will be good chance for students who want to share the ideas about new product or technology. Values we bring to you - Finding mentors, partners and potential consumers
            </p>
          </div>
          <div className="list-item">
            <div className="item-media">
            ...
            <p className="item-body">
              TechCamp Saigon Uni 2015 aims to bring the best people working in technology’s industry together and share their ideas.
            </p>
          </div>
        </div>
      </div>
